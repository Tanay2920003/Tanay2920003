                            ...
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" height="44" width="44">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="gauge info">
                                        ...
                                        <circle class="gauge-arc" transform="rotate(-90 28 28)" r="25" cx="28" cy="28" stroke-dasharray="50.013333333333335 155"/>
                                    </svg>
                            ...
                            <div class="info">
                                <div class="title">
                                    ...
                                    <div class="value-wrapper">
                                        <div class="value">1484</div>
                                    </div>
                                </div>
                                <div class="text">Starred 1484 repositories</div>
                            </div>
                        </div>
                        <div class="achievement s largeable-width-half">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" height="44" width="44">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="gauge info">
                                        <circle class="gauge-base" r="25" cx="28" cy="28"/>
                                        <circle class="gauge-arc" transform="rotate(-90 28 28)" r="25" cx="28" cy="28" stroke-dasharray="36.745333333333335 155"/>
                                    </svg>
                                    <svg xmlns="http://www.w3.org/2000/svg" mask="url(#mask)">
                            ...
                            <div class="info">
                                <div class="title">
                                    <span class="prefix">Master</span>
                                    maintainer
                                    <span class="gh">ranked 2.49k out of 221m repositories</span>
                                    <div class="value-wrapper">
                                        <div class="value">13556</div>
                                    </div>
                                </div>
                                <div class="text">Maintaining a repository with 13556 stars</div>
                            </div>
                        </div>
                        <div class="achievement a largeable-width-half">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" height="44" width="44">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="gauge info">
                                        <circle class="gauge-base" r="25" cx="28" cy="28"/>
                                        <circle class="gauge-arc" transform="rotate(-90 28 28)" r="25" cx="28" cy="28" stroke-dasharray="63.442847364818626 155"/>
                                    </svg>
                                    <svg xmlns="http://www.w3.org/2000/svg" mask="url(#mask)">
                        ...
                        <div class="achievement b largeable-width-half">
                            ...
                            <div class="info">
                                <div class="title">
                                    ...
                                    developer
                                    <span class="gh">ranked 1.36m out of 146m users</span>
                                    <div class="value-wrapper">
